...
function countProfit(shoppers) {
    ...
    shoppers.forEach((shopper) =>{
        ...
        if(product && product.leftOver >= shopper.amount){
            product.leftOver -= shopper.amount;
            product.shoppers.push(shopper.name);
            product.totalProfit += itemDetails[1] * shopper.amount
        }
